...
function(embed_all_systemlibs TARGET ROOT DEST)
  append_systemlib(${TARGET} ${HPHP_HOME}/hphp/system/php.txt sys_manifest)
  foreach(SLIB ${SYSTEMLIB_SOURCES})
    string(MD5 SLIB_HASH_NAME ${SLIB})
    # Some platforms limit section names to 16 characters :(
    string(SUBSTRING ${SLIB_HASH_NAME} 0 12 SLIB_HASH_NAME_SHORT)
    append_systemlib(${TARGET} "${HPHP_HOME}/${SLIB}" "sys_${SLIB_HASH_NAME_SHORT}")
  endforeach()
