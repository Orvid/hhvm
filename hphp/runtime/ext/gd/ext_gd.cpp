...
#define IMG_CONST(cns, val) Native::registerConstant<KindOfInt64> \
  (String::FromCStr("IMG_" #cns).get(), val)
    IMG_CONST(GIF, IMAGE_TYPE_GIF);
    IMG_CONST(JPG, IMAGE_TYPE_JPEG);
    IMG_CONST(JPEG, IMAGE_TYPE_JPEG);
    IMG_CONST(PNG, IMAGE_TYPE_PNG);
    IMG_CONST(WBMP, IMAGE_TYPE_WBMP);
    IMG_CONST(XPM, IMAGE_TYPE_XPM);
